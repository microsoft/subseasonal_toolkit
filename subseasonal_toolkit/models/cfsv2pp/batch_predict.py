...
#
# Example usages:
#   python src/models/cfsv2pp/batch_predict.py contest_tmp2m 34w -t std_val -i True -y all -m None
#   python src/models/cfsv2pp/batch_predict.py contest_precip 34w -t std_val -i True -y 20 -m 56
#   python src/models/cfsv2pp/batch_predict.py contest_precip 34w -t std_val -i True -y all -m 56 -d 35
#
# Positional args:
...
#     Cfsv2pp predictions; if "False" does not fit intercept; (default: "False")
...
#   --first_day (-fd): first available daily cfsv2pp forecast (1 or greater) to average
#   --last_day (-ld): last available daily cfsv2pp forecast (first_day or greater) to average
#   --loss (-l): loss function: mse, rmse, skill, or ssm (default: "mse")
#   --first_lead (-fl): first cfsv2pp lead to average into forecast (0-29) (default: 0)
#   --last_lead (-ll): last cfsv2pp lead to average into forecast (0-29) (default: 29)
import os
