# Generates predictions for each of the shift_deb_loess_ecmwf parameter configurations
#
# Example usage:
#   python -m subseasonal_toolkit.models.shift_deb_loess_ecmwf.bulk_batch_predict us_tmp2m_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
