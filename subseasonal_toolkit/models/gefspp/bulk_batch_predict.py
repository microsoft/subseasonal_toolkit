# Generates predictions for each of the GEFS++ parameter configurations
# used by the tuner
#
# Example usage:
#   python -m subseasonal_toolkit.models.gefspp.bulk_batch_predict contest_tmp2m 34w -t std_contest
#       
# Positional args:
...
if horizon == "56w":
    ...
    first_leads = [21, 0, 15, 15]
    last_leads = [21, 21, 21, 15]
elif horizon == "12w":
