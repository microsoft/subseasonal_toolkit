# Generates predictions for each of the tuned_ecmwfpps parameter configurations
#
# Example usage:
#   python -m subseasonal_toolkit.models.tuned_ecmwfpps.bulk_batch_predict us_tmp2m_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
...
for version in versions:
    ...
    param_str=f"-fw {version} -dw p+c -y 3 -m None"
