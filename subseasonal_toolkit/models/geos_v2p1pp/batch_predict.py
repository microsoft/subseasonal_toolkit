# Predicts outcomes using GEOS_V2p1++
#
# Example usage:
#   python models/geos_v2p1pp/batch_predict.py contest_tmp2m 34w -t std_val -y all -m None
#   python models/geos_v2p1pp/batch_predict.py contest_precip 34w -t std_val -y 20 -m 56
#
# Positional args:
