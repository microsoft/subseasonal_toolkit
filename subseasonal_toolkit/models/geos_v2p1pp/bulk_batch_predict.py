# Generates predictions for each of the GEOS_V2p1++ parameter configurations
# used by the tuner
#
# Example usage:
#   python -m subseasonal_toolkit.models.geos_v2p1pp.bulk_batch_predict contest_tmp2m 34w -t std_contest
#       
# Positional args:
