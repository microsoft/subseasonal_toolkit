# Generates predictions for each of the FIMr1p1++ parameter configurations
# used by the tuner
#
# Example usage:
#   python -m subseasonal_toolkit.models.fimr1p1pp.bulk_batch_predict contest_tmp2m 34w -t std_contest
#       
# Positional args:
