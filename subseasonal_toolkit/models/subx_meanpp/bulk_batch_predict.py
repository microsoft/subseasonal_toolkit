# Generates predictions for each of the subx_mean++ parameter configurations
# used by the tuner
#
# Example usage:
#   python -m subseasonal_toolkit.models.subx_meanpp.bulk_batch_predict us_precip_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
#   gt_id: us_precip_1.5x1.5 or us_tmp2m_1.5x1.5
#   horizon: 34w or 56w
#
# Named args:
