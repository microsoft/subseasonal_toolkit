# Predicts outcomes using raw (undebiased) geos_v2p1 ensemble forecast
#
# Example usage:
#   python src/models/raw_geos_v2p1/batch_predict.py contest_tmp2m 34w -t std_contest
#
# Positional args:
...
parser.add_argument('--first_lead', '-fl', default=0, 
                    help="first subx forecast lead to average into forecast (0-29)")
parser.add_argument('--last_lead', '-ll', default=29, 
                    help="last subxforecast lead to average into forecast (0-29)")
...
# Soft link prediction directory for this model to relevant subx forecast model 
# prediction directory
base_submodel_name = get_submodel_name(forecast=forecast, **vars(args))
