# Generates predictions for each of the CCSM4++ parameter configurations
# used by the tuner
#
# Example usage:
#   python -m subseasonal_toolkit.models.ccsm4pp.bulk_batch_predict contest_tmp2m 34w -t std_contest
#       
# Positional args:
