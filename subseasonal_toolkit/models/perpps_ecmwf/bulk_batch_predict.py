# Generates predictions for each of the Perpps-ECMWF parameter configurations
#
# Example usage:
#   python -m subseasonal_toolkit.models.perpps_ecmwf.bulk_batch_predict us_tmp2m_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
...
versions = [f"pf{ii}" for ii in range(1,51)]+["cf"]
...
for version in versions:
    ...
    param_str=f"-v {version} --train_years all --margin_in_days None"
