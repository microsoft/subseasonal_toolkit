...
from subseasonal_toolkit.models.deb_loess.attributes import get_submodel_name

FORECAST = "ecmwf"
MODEL_NAME = f"deb_loess_{FORECAST}"
...
def get_selected_submodel_name(gt_id, target_horizon):
    ...
    return get_submodel_name(**json_args, forecast_model=FORECAST)
