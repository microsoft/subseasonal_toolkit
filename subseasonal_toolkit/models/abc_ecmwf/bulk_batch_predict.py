# Generates predictions for each of the ABC-ECMWF parameter configurations
#
# Example usage:
#   python -m subseasonal_toolkit.models.abc_ecmwf.bulk_batch_predict us_tmp2m_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
...
module_str = f"-m subseasonal_toolkit.models.{base_model_name}.batch_predict"
...
for version in versions:
    ...
    param_str=f"-f {forecast}:{version}"
