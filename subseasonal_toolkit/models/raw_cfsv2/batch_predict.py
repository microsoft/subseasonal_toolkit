# Predicts outcomes using raw (undebiased) cfsv2 ensemble forecast
#
# Example usage:
#   python src/models/raw_cfsv2/batch_predict.py contest_tmp2m 34w -t std_contest
#
# Positional args:
...
model_name = "raw_cfsv2"
base_model_name = "cfsv2pp"
...
# Soft link prediction directory for this model to relevant cfsv2 model 
