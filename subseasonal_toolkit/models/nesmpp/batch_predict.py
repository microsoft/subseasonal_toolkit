# Predicts outcomes using NESM++
#
# Example usage:
#   python models/nesmpp/batch_predict.py contest_tmp2m 34w -t std_val -y all -m None
#   python models/nesmpp/batch_predict.py contest_precip 34w -t std_val -y 20 -m 56
#
# Positional args:
