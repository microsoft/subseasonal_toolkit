# Generates predictions for each of the Persistence++-ECMWF parameter configurations
#
# Example usage:
#   python -m subseasonal_toolkit.models.perpp_ecmwf.bulk_batch_predict us_tmp2m_1.5x1.5 34w -t std_paper_forecast
#       
# Positional args:
...
for version in versions:
    ...
    param_str=f"-y {train_years} -m {margin} -v {version}"
